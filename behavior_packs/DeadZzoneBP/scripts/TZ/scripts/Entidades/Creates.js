...
const cratesConfig = {
    "tz:crate_oak": {
        ...
        items: [
            ...
            { id: "krep:qsz92", name: "Glock 17", amount: 1 },
            { id: "krep:mm9", name: "9mm", amount: 5 },
            { id: "krep:qsz92", name: "M1911", amount: 1 },
            { id: "krep:mm9", name: ".45 ACP", amount: 5 },
            { id: "krep:qcq171", name: "Double Barrel", amount: 1 },
            { id: "krep:mm9", name: "12 Gauge", amount: 4 },
            { id: "krep:qcq171", name: "UZI", amount: 1 },
            { id: "krep:mm9", name: "9mm", amount: 6 },
            { id: "krep:qcq171", name: "MP5", amount: 1 },
    ...
    "tz:crate_oro": {
        ...
        items: [
            ...
            { id: "krep:qsz92", name: "Desert Eagle", amount: 1 },
            { id: "krep:mm5821", name: ".50 AE", amount: 8 },
            { id: "krep:t50", name: "T50", amount: 1 },
            { id: "krep:mm5821", name: ".50 AE", amount: 8 },
            { id: "krep:qcq171", name: "UMP-45", amount: 1 },
            { id: "krep:mm9", name: ".45 ACP", amount: 12 },
            { id: "krep:qcq171", name: "MP7", amount: 1 },
            { id: "krep:mm9", name: "4.6x30mm", amount: 12 },
            { id: "krep:qcq171", name: "Vector", amount: 1 },
            { id: "krep:mm9", name: ".45 ACP", amount: 12 },
            { id: "krep:qcq171", name: "M870", amount: 1 },
            { id: "krep:mm9", name: "12 Gauge", amount: 10 },
            { id: "krep:qbu191", name: "SKS", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 15 },
            // Consumibles
            { id: "minecraft:golden_apple", name: "Golden Apple", amount: 4 },
    ...
    "tz:crate_emerald": {
        ...
        items: [
            ...
            { id: "krep:ak12", name: "AKM", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 20 },
            { id: "krep:m16", name: "M16", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 20 },
            { id: "krep:t112", name: "M16A1", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 20 },
            { id: "krep:type89", name: "G36", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 20 },
            { id: "krep:arka", name: "Type 81", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 20 },
            { id: "krep:m8", name: "G3", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 18 },
            { id: "krep:m8", name: "FAL", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 18 },
            // Escopetas avanzadas
            { id: "krep:qcq171", name: "AA-12", amount: 1 },
            { id: "krep:mm9", name: "12 Gauge", amount: 12 },
            { id: "krep:qcq171", name: "Saiga-12", amount: 1 },
            { id: "krep:mm9", name: "12 Gauge", amount: 12 },
            // Sniper básico
            { id: "krep:awp", name: "Win 308", amount: 1 },
    ...
    "tz:crate_diamond": {
        ...
        items: [
            ...
            // ARs premium
            { id: "krep:type95", name: "M4A1", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 30 },
            { id: "krep:hk416", name: "HK416", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 30 },
            { id: "krep:k2", name: "SCAR-L", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 30 },
            { id: "krep:qjb95", name: "QBZ-95", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 30 },
            { id: "krep:qbz191", name: "QBZ-191", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 30 },
            // LMGs
            { id: "krep:rpk", name: "RPK", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 40 },
            { id: "krep:type882", name: "M249", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 40 },
            // Snipers premium
            { id: "krep:awp", name: "AWP", amount: 1 },
            { id: "krep:lapua338", name: ".338 Lapua", amount: 15 },
            { id: "krep:awp", name: "M88.5", amount: 1 },
            { id: "krep:lapua338", name: ".338 Lapua", amount: 15 },
            // P90 y SMG premium
            { id: "krep:qcq171", name: "P90", amount: 1 },
            { id: "krep:mm556", name: "5.7x28mm", amount: 20 },
            // Consumibles premium
    ...
    "tz:crate_netherita": {
        ...
        items: [
            ...
            { id: "krep:m7", name: "SCAR-H", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 40 },
            { id: "krep:qbu191", name: "MK14", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 40 },
            // LMGs premium
            { id: "krep:qjb201", name: "Evolys", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 50 },
            { id: "krep:type882", name: "M249", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 50 },
            // Snipers .50 BMG
            ...
            { id: "krep:mm545", name: "7.62x39mm", amount: 60 },
            { id: "krep:minigun", name: "Minigun", amount: 1 },
            { id: "krep:mm545", name: "7.62x39mm", amount: 60 },
            // RPG (muy raro)
