    ...
    const mensajes = {
       ...
       // player.runCommand('scoreboard players add @s TzCoins 0')
        ...
        if (!player.hasTag("tz_kit_inicio")) {
            ...
            player.runCommand('give @s bed 1 0 {"keep_on_death":{}}')
            player.runCommand('give @s bed 1 0 {"keep_on_death":{}}')
            player.runCommand('give @s krep:g17 1 0 {"keep_on_death":{}}')
            player.runCommand('give @s krep:mm9 50 0 {"keep_on_death":{}}')
           ...
           // player.runCommand('tag @s add radio_connected')
            ...
            player.runCommand('give @s crossbow 1 0 {"keep_on_death":{}}')
            ...
            player.runCommand('give @s rt:11x11_block 1 0 {"keep_on_death":{}}')
            ...
            player.runCommand('give @s arrow 64 0 {"keep_on_death":{}}')
            // player.runCommand('give @s md:miter_saw 1 0 {"keep_on_death":{}}')
            player.runCommand('give @s oak_log 16 0 {"keep_on_death":{}}')
