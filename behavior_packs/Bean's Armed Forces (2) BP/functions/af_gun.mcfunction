...
playanimation @e[tag=is_player,tag=player_sneaking,tag=holding_af_anygun] animation.af_gun_tp.tp_sneak
playanimation @e[tag=is_player,tag=!player_sneaking,tag=holding_af_anygun] animation.af_gun_tp.tp_nosneak
